...
export const SignOutTopBar = () => {
  ...
  return (
    <header className="bg-gray">
      <div className="container p-[2.5rem] flex h-14 items-center justify-between">
        <Link
          href={homeHref}
          aria-label={t("brand")}
        ...
        <nav className="flex items-center gap-[2.5rem]">
          ...
          <button
            type="button"
            disabled
            className="w-[9.375rem] cursor-not-allowed font-medium bg-blue rounded-[0.5rem] py-[0.5rem] px-[0.75rem] gap-[0.5rem]"
          >
            {t("register")}
          </button>
        </nav>
